...
ax1.set_ylabel(r'Rashba Parameter $\mathbf{\alpha_R\, (eV \AA)}$', color='r', fontsize=18, fontweight='bold')

ax1.plot(st, rb, marker='s', markersize=10,linestyle='-', linewidth = 4, color='r', markeredgecolor='black', label=r'$\mathbf{\alpha_R :\Gamma-M}$')
...
fig.tight_layout()
plt.savefig('Rashba_HER_vs_strain.png', dpi=600, bbox_inches='tight')
plt.show()
